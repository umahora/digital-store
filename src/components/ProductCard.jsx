const ProductCard = ({ product }) => {
    ...
    return (
        <div className="flex flex-col items-center leading-6">
            {/* 292x321 */}
            <div className="flex place-items-center p-5 bg-white rounded-md relative h-[180px] md:h-[250px] lg:h-[270px] xl:h-[321px] duration-300 ease-in-out hover:-translate-y-[4px] hover:shadow-md cursor-pointer">
                {discount && (
                    <div className="absolute top-3.5 left-3.5 px-4 py-1.5 leading-5.5 tracking-wide font-bold text-xs md:text-sm text-dark-gray-2 rounded-full bg-[#E7FF86]">
                        {discount}% OFF
                    </div>
                )}
